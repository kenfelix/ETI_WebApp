...
const Hero: FC<HeroProps> = () => {
    ...
    return (
        <div className="relative w-full h-[500px]">
                ...
                />
            <div className='flex flex-col gap-5 text-white absolute top-[50px] p-[20px] md:pl-[40px] lg:left-[200px] max-w-lg'>
                <p className='font-bold shadow-sm text-lg'>We do it for People in need</p>
                <h3 className='font-extrabold shadow-sm text-[50px] leading-[50px] lg:text-[70px] lg:leading-[70px] font-serif'>The Power to choose in a child's hands </h3>
