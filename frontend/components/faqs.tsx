...
const FAQs: FC<FAQsProps> = () => {
    return (
        <div className='px-[20px] lg:px-[70px] py-[30px] w-full'>
            <div className='bg-[#FFF6F1] flex flex-col md:flex-row gap-10 justify-center items-center w-full px-[15px] md:px-0 py-[70px]'>
                ...
                {/* right */}
                <div className='flex flex-col md:max-w-[30%] gap-4'>
                    {Q_A.map((qa, index) => (
